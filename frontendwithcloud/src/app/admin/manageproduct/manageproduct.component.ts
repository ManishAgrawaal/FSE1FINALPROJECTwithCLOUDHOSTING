...
export class ManageproductComponent implements OnInit {
  ...
  {
    console.log("hi");
    this.http.get("https://shopping20221215212046.azurewebsites.net/api/Product/all")
  ...
  AddProduct() {
    ...
    this.http.post("https://shopping20221215212046.azurewebsites.net/api/Product/productname/add", addData)
  ...
  DeleteProduct(prod: Productstbl) {
    ...
    this.http.delete("https://shopping20221215212046.azurewebsites.net/api/Product/productname/delete/id", options)
    .subscribe(res => { this.ShowData(); console.log(res) }, res => console.log(res));
